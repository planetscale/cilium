...
func defaultLabelPrefixCfg() *labelPrefixCfg {
	...
	expressions := []string{
		...
		// Ignore irrelevant labels added by AKS.
		"!io.cilium.k8s.namespace.labels.addonmanager.kubernetes.io/mode",
		"!io.cilium.k8s.namespace.labels.kubernetes.io/cluster-service",
		"!io.cilium.k8s.namespace.labels.control-plane",
		"!version",
	}
